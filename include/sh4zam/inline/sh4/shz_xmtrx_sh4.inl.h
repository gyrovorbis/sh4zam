...
void shz_xmtrx_load_apply_store_aligned4_4x4_sh4(float out[16],
                                                 const float mat1[16],
                                                 const float mat2[16]);
...
SHZ_INLINE void shz_xmtrx_load_apply_aligned4_4x4_sh4(const float matrix1[16],
...
SHZ_INLINE void shz_xmtrx_apply_aligned4_4x4_sh4(const float matrix[16]) SHZ_NOEXCEPT {
    asm volatile(R"(
        pref    @%[mtx]
        mov     r15, r0
        or      #0x0f, r0
...
SHZ_INLINE void shz_xmtrx_apply_4x4_sh4(const shz_mat4x4_t* matrix) SHZ_NOEXCEPT {
    asm volatile(R"(
        pref    @%[mtx]
        mov     r15, r0
        or      #0x0f, r0
...
SHZ_INLINE void shz_xmtrx_scale_sh4(float x, float y, float z) SHZ_NOEXCEPT {
    asm volatile(R"(
        fmov.s  @%[x], fr0
        fldi0   fr1
        fldi0   fr2
...
SHZ_INLINE void shz_xmtrx_init_fft_weights_sh4(float angle) SHZ_NOEXCEPT {
    angle *= SHZ_FSCA_RAD_FACTOR;
